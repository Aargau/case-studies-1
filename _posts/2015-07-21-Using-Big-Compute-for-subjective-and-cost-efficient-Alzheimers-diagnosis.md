---
layout: post
title:  "Using Big Compute for subjective and cost efficient Alzheimer’s diagnosis"
author: "Petro Soininen"
#author-link: "http://#"
#author-image: "{{ site.baseurl }}/images/PetroSoininen/photo.jpg" //should be square dimensions
date:   2015-07-21 23:34:28
categories: Image processing, Azure
color: "blue"
#image: "{{ site.baseurl }}/images/imagename.png" #should be ~350px tall
excerpt: Using Big Compute for subjective and cost efficient Alzheimer’s diagnosis – Taking Combinostics’ Volumetric (3D) brain image processing to the cloud
---

# DRAFT

# Using Big Compute for subjective and cost efficient Alzheimer’s diagnosis – Taking Combinostics’ Volumetric (3D) brain image processing to the cloud
...
![]({{ site.url }}/case-studies/images/2015-07-21-Using-Big-Compute-for-subjective-and-cost-efficient-Alzheimers-diagnosis_images/image001.jpg)
